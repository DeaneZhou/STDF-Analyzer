...
namespace UI_Chart.Views
{
    ...
    public partial class Trend : UserControl, INavigationAware
    {
        ...
        private float _allsigmaLowTrend,
            _allsigmaHighTrend;
        private float _allsigmaLowHisto,
            _allsigmaHighHisto;
        ...
        {
            if (!para.Item1.Equals(_subData))
                return;
            if (para.Item2 == null || para.Item2.Count == 0)
                return;
        ...
        void UpdateTrend()
        {
            ...
            for (int i = 0; i < (_selectedIds.Count > 16 ? 16 : _selectedIds.Count); i++)
            {
                ...
                trendChart.Plot.AddScatter(
                    s.Item1,
                    s.Item2,
                    Color.FromArgb(color.A, color.R, color.G, color.B),
                    lineWidth: 0,
                    label: _selectedIds[i]
                );
            }
            ...
            for (int i = 0; i < (_selectedIds.Count > 16 ? 16 : _selectedIds.Count); i++)
            {
                ...
                {
                    statistic = da.GetFilteredStatisticIgnoreOutlier(
                        _subData.FilterId,
                        _selectedIds[i],
                        SigmaByIdx(comboboxOutlierSigma.SelectedIndex)
                    );
                }
                else
                {
                ...
                if (i == 0)
                {
                    ...
                    _allsigmaLowTrend = statistic.GetSigmaRangeLow(
                        SigmaByIdx(comboboxSigma.SelectedIndex)
                    );
                    _allsigmaHighTrend = statistic.GetSigmaRangeHigh(
                        SigmaByIdx(comboboxSigma.SelectedIndex)
                    );
                    ...
                    if (_selectedIds.Count == 1)
                    {
                        ...
                        var failRate =
                            (statistic.FailCount * 100.0 / statistic.ValidCount).ToString("f3")
                            + "%";
                        _itemTitleTrend =
                ...
                else
                {
                    ...
                    var sigmaLow = statistic.GetSigmaRangeLow(
                        SigmaByIdx(comboboxSigma.SelectedIndex)
                    );
                    var sigmaHigh = statistic.GetSigmaRangeHigh(
                        SigmaByIdx(comboboxSigma.SelectedIndex)
                    );

                    if (sigmaLow < _allsigmaLowTrend)
                        _allsigmaLowTrend = sigmaLow;
                    if (sigmaHigh > _allsigmaHighTrend)
                        _allsigmaHighTrend = sigmaHigh;
            ...
            for (int i = 0; i < (_selectedIds.Count > 16 ? 16 : _selectedIds.Count); i++)
            {
                ...
                if (toggleOutlierHisto.IsChecked.Value)
                {
                    statistic = da.GetFilteredStatisticIgnoreOutlier(
                        _subData.FilterId,
                        _selectedIds[i],
                        SigmaByIdx(comboboxOutlierSigmaHisto.SelectedIndex)
                    );
                }
                else
                {
                ...
                if (i == 0)
                {
                    ...
                    _allsigmaLowHisto = statistic.GetSigmaRangeLow(
                        SigmaByIdx(comboboxSigmaHisto.SelectedIndex)
                    );
                    _allsigmaHighHisto = statistic.GetSigmaRangeHigh(
                        SigmaByIdx(comboboxSigmaHisto.SelectedIndex)
                    );
                ...
                else
                {
                    ...
                    if (sigmaLow < _allsigmaLowHisto)
                        _allsigmaLowHisto = sigmaLow;
                    if (sigmaHigh > _allsigmaHighHisto)
                        _allsigmaHighHisto = sigmaHigh;
        ...
        (double[], double[], double) GetHistogramData(
            double start,
            double stop,
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            if (!_subData.Equals(data))
            {
                ...
                _selectedIds = new List<string>(
                    (List<string>)navigationContext.Parameters["itemList"]
                );
        ...
        void UpdateAxis_Trend()
        {
            ...
            {
                lineLLimit_Trend = trendChart.Plot.AddHorizontalLine(
                    _lowLimit,
                    Color.Red,
                    2,
            ...
            {
                lineHLimit_Trend = trendChart.Plot.AddHorizontalLine(
                    _highLimit,
                    Color.Red,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMean_Trend = trendChart.Plot.AddHorizontalLine(
                    _meanTrend,
                    Color.Tomato,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMedian_Trend = trendChart.Plot.AddHorizontalLine(
                    _medianTrend,
                    Color.DarkGoldenrod,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMin_Trend = trendChart.Plot.AddHorizontalLine(
                    _minTrend,
                    Color.IndianRed,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMax_Trend = trendChart.Plot.AddHorizontalLine(
                    _maxTrend,
                    Color.IndianRed,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineLSigma6_Trend = trendChart.Plot.AddHorizontalLine(
                    _sigma6LTrend,
                    Color.DeepSkyBlue,
                    1,
            ...
            {
                lineHSigma6_Trend = trendChart.Plot.AddHorizontalLine(
                    _sigma6HTrend,
                    Color.DeepSkyBlue,
                    1,
                    ScottPlot.LineStyle.Dash
            ...
            {
                lineLSigma3_Trend = trendChart.Plot.AddHorizontalLine(
                    _sigma3LTrend,
                    Color.Lime,
                    1,
                    ScottPlot.LineStyle.Dash
            ...
            {
                lineHSigma3_Trend = trendChart.Plot.AddHorizontalLine(
                    _sigma3HTrend,
                    Color.Lime,
                    1,
                    ScottPlot.LineStyle.Dash
        ...
        void UpdateAxis_Histo()
        {
            ...
            {
                lineLLimit_Histo = histoChart.Plot.AddVerticalLine(
                    _lowLimit,
                    Color.Red,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineHLimit_Histo = histoChart.Plot.AddVerticalLine(
                    _highLimit,
                    Color.Red,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMean_Histo = histoChart.Plot.AddVerticalLine(
                    _meanHisto,
                    Color.Tomato,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMedian_Histo = histoChart.Plot.AddVerticalLine(
                    _medianHisto,
                    Color.DarkGoldenrod,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMin_Histo = histoChart.Plot.AddVerticalLine(
                    _minHisto,
                    Color.IndianRed,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineMax_Histo = histoChart.Plot.AddVerticalLine(
                    _maxHisto,
                    Color.IndianRed,
                    2,
                    ScottPlot.LineStyle.Solid
            ...
            {
                lineLSigma6_Histo = histoChart.Plot.AddVerticalLine(
                    _sigma6LHisto,
                    Color.DeepSkyBlue,
                    1,
                    ScottPlot.LineStyle.Dash
            ...
            {
                lineHSigma6_Histo = histoChart.Plot.AddVerticalLine(
                    _sigma6HHisto,
                    Color.DeepSkyBlue,
                    1,
                    ScottPlot.LineStyle.Dash
            ...
            {
                lineLSigma3_Histo = histoChart.Plot.AddVerticalLine(
                    _sigma3LHisto,
                    Color.Lime,
                    1,
                    ScottPlot.LineStyle.Dash
            ...
            {
                lineHSigma3_Histo = histoChart.Plot.AddVerticalLine(
                    _sigma3HHisto,
                    Color.Lime,
                    1,
                    ScottPlot.LineStyle.Dash
        ...
        private void CmdSaveTrend_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            var txt = StdDB
                .GetDataAcquire(_subData.StdFilePath)
                .GetTestInfo(_selectedIds[0])
                .TestText;
        ...
        private void comboboxOutlierSigma_SelectionChanged(
            object sender,
        ...
        private void comboboxOutlierSigmaHisto_SelectionChanged(
            object sender,
            SelectionChangedEventArgs e
        )
        {
        ...
        private void trendChart_MouseDoubleClick(
            object sender,
        ...
        private void histoChart_MouseDoubleClick(
            object sender,
            System.Windows.Input.MouseButtonEventArgs e
        )
        {
