...
namespace SillyMonkey.Core
{
    public static class SA
    {
        ...
        public static ChartAxisType HistogramChartAxis
        {
            get
            {
                return (ChartAxisType)
                    Enum.Parse(typeof(ChartAxisType), Settings.Default.HistogramChartAxis);
            }
        ...
        public static SigmaRangeType HistogramChartAxisSigmaRange
        {
            get
            {
                return (SigmaRangeType)
                    Enum.Parse(
                        typeof(SigmaRangeType),
                        Settings.Default.HistogramChartAxisSigmaRange
                    );
            }
        ...
        public static SigmaRangeType HistogramOutlierFilterRange
        {
            get
            {
                return (SigmaRangeType)
                    Enum.Parse(
                        typeof(SigmaRangeType),
                        Settings.Default.HistogramOutlierFilterRange
                    );
            }
        ...
        public static ChartAxisType TrendChartAxis
        {
            ...
            {
                return (ChartAxisType)
                    Enum.Parse(typeof(ChartAxisType), Settings.Default.TrendChartAxis);
            }
        ...
        public static SigmaRangeType TrendChartAxisSigmaRange
        {
            ...
            {
                return (SigmaRangeType)
                    Enum.Parse(typeof(SigmaRangeType), Settings.Default.TrendChartAxisSigmaRange);
            }
        ...
        public static SigmaRangeType TrendOutlierFilterRange
        {
            ...
            {
                return (SigmaRangeType)
                    Enum.Parse(typeof(SigmaRangeType), Settings.Default.TrendOutlierFilterRange);
            }
        ...
        public static ChartAxisType CorrHistogramChartAxis
        {
            ...
            {
                return (ChartAxisType)
                    Enum.Parse(typeof(ChartAxisType), Settings.Default.CorrHistogramChartAxis);
            }
        ...
        public static SigmaRangeType CorrHistogramOutlierFilterRange
        {
            get
            {
                return (SigmaRangeType)
                    Enum.Parse(
                        typeof(SigmaRangeType),
                        Settings.Default.CorrHistogramOutlierFilterRange
                    );
            }
        ...
        public static SigmaRangeType ItemCorrOutlierFilterRange
        {
            ...
            {
                return (SigmaRangeType)
                    Enum.Parse(typeof(SigmaRangeType), Settings.Default.ItemCorrOutlierFilterRange);
            }
        ...
        {
            var regSubKey = Microsoft.Win32.Registry.CurrentUser.CreateSubKey(
                @"Software\SillyMonkeyStdfAnalyzer"
            );
        ...
        {
            var regSubKey = Microsoft.Win32.Registry.CurrentUser.OpenSubKey(
                @"Software\SillyMonkeyStdfAnalyzer"
            );
            if (regSubKey is null)
            {
        ...
        public static void CreateAssociation(
            ...
            string description,
            string application,
            string icon /*, KeyHiveSmall hive = KeyHiveSmall.CurrentUser*/
        )
        {
            ...
            Microsoft
                .Win32.Registry.CurrentUser.CreateSubKey(@"Software\Classes\" + extension)
                .SetValue("", ProgID);
            ...
            if (selectedKey != null)
            {
                ...
                if (icon != null)
                {
                    selectedKey
                        ...
                        .SetValue("", icon, RegistryValueKind.ExpandString);
        ...
        public static void SelfCreateAssociation(
            string extension /*, KeyHiveSmall hive = KeyHiveSmall.CurrentUser*/
            ,
            string description = ""
        )
        {
